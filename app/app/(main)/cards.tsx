...
const CardGallery: React.FC = () => {
  ...
  // Calculate available content width (accounting for sidebar)
  const contentWidth = useMemo(() => {
    if (isMobile) return screenWidth;
    const sidebarWidth = isExpanded ? SidebarTheme.expandedWidth : SidebarTheme.collapsedWidth;
    return screenWidth - sidebarWidth;
  }, [screenWidth, isMobile, isExpanded]);
